            ...
            {Array.from({ length: PAGE_SIZE }).map((_, i) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onPointerDown={() => onRemove(d.entityType, d.entityId)}
                    className="w-10 h-10 flex items-center justify-center rounded-lg text-red-400 active:bg-red-50 text-sm font-bold shrink-0"
                  >
                    ✕
                  </button>
                </div>
