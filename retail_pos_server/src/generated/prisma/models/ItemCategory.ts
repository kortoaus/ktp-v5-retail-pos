...
export type ItemCategoryWhereUniqueInput = Prisma.AtLeast<{
  itemId_categoryId?: Prisma.ItemCategoryItemIdCategoryIdCompoundUniqueInput
  AND?: Prisma.ItemCategoryWhereInput | Prisma.ItemCategoryWhereInput[]
  OR?: Prisma.ItemCategoryWhereInput[]
  NOT?: Prisma.ItemCategoryWhereInput | Prisma.ItemCategoryWhereInput[]
  itemId?: Prisma.IntFilter<"ItemCategory"> | number
...
export type ItemCategoryCreateInput = {
  ...
  item: Prisma.ItemCreateNestedOneWithoutCategoriesInput
}
...
export type ItemCategoryUpdateInput = {
  ...
  item?: Prisma.ItemUpdateOneRequiredWithoutCategoriesNestedInput
}
...
export type ItemCategoryItemIdCategoryIdCompoundUniqueInput = {
  itemId: number
  categoryId: number
}
...
export type ItemCategoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"itemId" | "categoryId", ExtArgs["result"]["itemCategory"]>
...
export interface ItemCategoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const itemCategoryWithItemIdOnly = await prisma.itemCategory.findMany({ select: { itemId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ItemCategories and only return the `itemId`
   * const itemCategoryWithItemIdOnly = await prisma.itemCategory.createManyAndReturn({
   *   select: { itemId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ItemCategories and only return the `itemId`
   * const itemCategoryWithItemIdOnly = await prisma.itemCategory.updateManyAndReturn({
   *   select: { itemId: true },
   *   where: {
   *     // ... provide filter here
   *   },
